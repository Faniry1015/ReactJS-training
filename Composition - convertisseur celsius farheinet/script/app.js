/**Exemple d'utilisation des compositions */
...
function Button({type, children}) {
    const classN = `btn btn-${type}`
    return <button className={classN} >{children}</button>
}

function ButtonPrimary() {
    return <Button type="primary">Envoyer</Button>
}

function ButtonSecondary() {
    return <Button type="secondary">Envoyer2</Button>
}
...
class Calculator extends React.Component {
    ...
    render() {
        ...
        return <div className="container mt-4">
            <Column2 left={<TemperatureInput scale="c" temperature={celsius} onTemperatureChange={this.handleCelsiusChange}/>} right={<TemperatureInput scale="f" temperature={fahrenheit} onTemperatureChange={this.handleFahrenheitChange} />} /> 
            <hr />
